...
maryland_df = pd.read_csv("/Users/caspar/Desktop/Folders/CompSci/DataScience/Data-Science-Final-Project/data/MARYLAND-Violent_Crime___Property_Crime_by_County__1975_to_Present_20240320.csv")


maryland_df = maryland_df[maryland_df['YEAR'] >= 2000]
...
# Load New York.csv
new_york_df = pd.read_csv("/Users/caspar/Desktop/Folders/CompSci/DataScience/Data-Science-Final-Project/data/NEW_YORK_CRIME.csv")
new_york_df['State'] = 'NY'
maryland_df['State'] = 'MD'
